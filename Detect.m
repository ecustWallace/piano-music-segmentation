...
%DETECT MATLAB code file for Detect.fig
...
%
%      DETECT('Property','Value',...) creates a new DETECT using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to Detect_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      DETECT('CALLBACK') and DETECT('CALLBACK',hObject,...) call the
%      local function named CALLBACK in DETECT.M with the given input
%      arguments.
%
...
% Last Modified by GUIDE v2.5 14-Mar-2017 22:56:25
...
[filename,filepath]=uigetfile('*.m4a','选择音频');%gui中打开文件

global filep
filep = strcat(filepath,filename);
global workaudio
global fs
[workaudio,fs] = audioread(filep);
axes(handles.axes1);
plot(workaudio);
axis([0,length(workaudio),-max(workaudio)*1.2,max(workaudio)*1.2]);
...
precision = str2double(get(handles.precision,'String'));
Elimit = str2double(get(handles.Elimit,'String'));
simlimit = str2double(get(handles.simlimit,'String'));
frame = 1000;
tic;
n = simfilter_GUI(workaudio,fs,speed,precision,bias,Elimit,simlimit,frame);
toc;
N=n.*frame;
axes(handles.axes1);
hold on;
o = ones(1,length(N));
stem(N,o.*(max(workaudio)*1.1));
hold off;
set(handles.text10,'String',num2str(length(n)));
...
function Elimit_Callback(hObject, eventdata, handles)
% hObject    handle to Elimit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of Elimit as text
%        str2double(get(hObject,'String')) returns contents of Elimit as a double


% --- Executes during object creation, after setting all properties.
function Elimit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to Elimit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function simlimit_Callback(hObject, eventdata, handles)
% hObject    handle to simlimit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of simlimit as text
%        str2double(get(hObject,'String')) returns contents of simlimit as a double


% --- Executes during object creation, after setting all properties.
function simlimit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to simlimit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
